...
const getToJsonSchemaFn = async (vendor) => {
  switch (vendor) {
    ...
    case "effect":
      return import('./effect-BqN--3bg.js').then(async ({ getToJsonSchemaFn: getToJsonSchemaFn2 }) => getToJsonSchemaFn2());
    case "sury":
      return import('./sury-DT-CKDzo.js').then(async ({ getToJsonSchemaFn: getToJsonSchemaFn2 }) => getToJsonSchemaFn2());
    case "valibot":
      return import('./valibot-CR9aQ3tY.js').then(async ({ getToJsonSchemaFn: getToJsonSchemaFn2 }) => getToJsonSchemaFn2());
    case "zod":
      return import('./zod-DRPNNiyo.js').then(async ({ getToJsonSchemaFn: getToJsonSchemaFn2 }) => getToJsonSchemaFn2());
    default:
