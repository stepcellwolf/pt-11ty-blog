...
(function() {
  ...
  const pages = [
    ...
    { title: 'Project', url: '/projects/', description: 'My projects' },
    { title: 'Publications', url: '/publications/', description: 'International and Book publications' },
    { title: 'Talks', url: '/talks/', description: 'My public talks' },
    { title: 'Teach', url: '/teaching/', description: 'Teaching and mentoring' },
    { title: 'Photography', url: '/photography/', description: 'My photography' },
    { title: 'CV', url: '/resume/', description: 'My profesional resume - CV' },
  ];
